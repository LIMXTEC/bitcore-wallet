...
public class Configuration {
    ...
    public static final String PREFS_KEY_BTX_PRECISION = "btc_precision";
    ...
    private static final int PREFS_DEFAULT_BTX_SHIFT = 0;
    private static final int PREFS_DEFAULT_BTX_PRECISION = 8;
    ...
    private int getBtcPrecision() {
        final String precision = prefs.getString(PREFS_KEY_BTX_PRECISION, null);
        if (precision != null)
            return precision.charAt(0) - '0';
        else
            return PREFS_DEFAULT_BTX_PRECISION;
    }
    ...
    public int getBtcShift() {
        ...
        if (precision != null)
            ...
            return PREFS_DEFAULT_BTX_SHIFT;
    }
