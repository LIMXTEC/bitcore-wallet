...
public final class Constants {
    ...
    public final static class Files {
        ...
        public static final String EXTERNAL_WALLET_KEY_BACKUP = "bitcore-wallet-keys" + FILENAME_NETWORK_SUFFIX;

        /** Filename of the manual wallet backup. */
        public static final String EXTERNAL_WALLET_BACKUP = "bitcore-wallet-backup" + FILENAME_NETWORK_SUFFIX;
    ...
    public static final String WALLET_NAME_CURRENCY_CODE = "btx";
    ...
    public static final String MIMETYPE_WALLET_BACKUP = "application/x-bitcore-wallet-backup";

    /** Number of confirmations until a transaction is fully confirmed. */
    public static final int MAX_NUM_CONFIRMATIONS = 7;

    /** User-agent to use for network access. */
    public static final String USER_AGENT = "Bitcore Wallet";

    /** Default currency to use if all default mechanisms fail. */
    public static final String DEFAULT_EXCHANGE_CURRENCY = "USD";

    /** Donation address for tip/donate action. */
    public static final String DONATION_ADDRESS = "14aciUAZdKgPn4HeaQtr4EkMrL2sQteyWB";
    ...
    public static final String SOURCE_URL = "https://github.com/LIMXTEC/bitcore-wallet";
    public static final String BINARY_URL = "https://github.com/LIMXTEC/bitcore-wallet/releases";
