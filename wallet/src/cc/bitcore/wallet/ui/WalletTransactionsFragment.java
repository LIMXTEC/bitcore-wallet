...
import cc.bitcore.wallet.ui.TransactionsAdapter.Warning;
import cc.bitcore.wallet.ui.send.RaiseFeeDialogFragment;
import cc.bitcore.wallet.util.BitmapFragment;
import cc.bitcore.wallet.util.CrashReporter;
import cc.bitcore.wallet.util.Qr;
import cc.bitcore.wallet.util.ThrottlingWalletChangeListener;
...
public class WalletTransactionsFragment extends Fragment implements LoaderCallbacks<List<Transaction>>,
    ...
    public void onSharedPreferenceChanged(final SharedPreferences sharedPreferences, final String key) {
        if (Configuration.PREFS_KEY_BTX_PRECISION.equals(key) || Configuration.PREFS_KEY_REMIND_BACKUP.equals(key))
            updateView();
    }
