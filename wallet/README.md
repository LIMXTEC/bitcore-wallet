...
storage:
    ...
    Mainnet: /data/data/cc.bitcore.wallet/files/wallet-protobuf
    Testnet: /data/data/cc.bitcore.wallet/files/wallet-protobuf-testnet
...
Certain actions cause automatic rolling backups of your wallet to app-private storage:
    ...
    Mainnet: /data/data/cc.bitcore.wallet/files/key-backup-protobuf
    Testnet: /data/data/cc.bitcore.wallet/files/key-backup-protobuf-testnet
...
app-private storage:
    ...
    Mainnet: /data/data/cc.bitcore.wallet/files/fees.txt
    Testnet: /data/data/cc.bitcore.wallet/files/fees-testnet.txt
...
Wallet file for Testnet can be pulled from an (even un-rooted) device using:
    ...
    adb pull /data/data/cc.bitcore.wallet/files/wallet-protobuf-testnet
